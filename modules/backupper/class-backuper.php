 ...
 * Description: Keep safe your <strong>Infusionsoft®</strong> data by scheduling backup of contacts and tags.
 *
...
class IFG_Backupper extends IFG_Module{
	...
	public function manual_backup(){
		...
		$nonce = $this->utility->rgar($_POST, 'ifg-'.self::$slug.'-security');

		if(isset($_POST['ifg-'.self::$slug.'-security']) && wp_verify_nonce($nonce, 'ifg-security')){
