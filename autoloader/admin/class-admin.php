...
class IFG_Admin {
	...
	public function __construct() {
		...
		$this->loader->add_action( 'init', $this, 'process_modules' );
		$this->loader->run();
	...
	public function admin_assets() {
		...
		wp_localize_script( 'ifg-admin', 'ifg', array(
			...
			'ajaxNonce' => wp_create_nonce( 'ifg-security' )
		));
	}
	...
	public function app_settings_notice() {
		...
		$msg = sprintf(
			...
			'<a href="'.admin_url('admin.php?page=ifg-settings').'">Infusionsoft Application</a>'
		);
	...
	public function toggle_module_status(){
		...
		$nonce = $this->utility->rgar($_POST, 'ifg-module-security');

		if(isset($_POST['ifg-activate-module']) && wp_verify_nonce($nonce, 'ifg-module-security')){
		        		...
		        		<div class="col-md-6 col-lg-4">
			            	<div class="module <?php echo $status;?>">
		            			...
		            			<form action="" method="post">
		            				<input type="hidden" name="ifg-module-security" value="<?php echo wp_create_nonce( 'ifg-module-security' );?>">
